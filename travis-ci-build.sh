...
cmake \
    ...
    -D Boost_CHRONO_LIBRARY=$DEPSDIR/lib/libboost_chrono-gcc48-mt-1_55.so.1.55.0 \
    -D Boost_DATE_TIME_LIBRARY=$DEPSDIR/lib/libboost_date_time-gcc48-mt-1_55.so.1.55.0 \
    -D Boost_FILESYSTEM_LIBRARY=$DEPSDIR/lib/libboost_filesystem-gcc48-mt-1_55.so.1.55.0 \
    -D Boost_PYTHON_LIBRARY=$DEPSDIR/lib/libboost_python-gcc48-mt-1_55.so.1.55.0 \
    -D Boost_REGEX_LIBRARY=$DEPSDIR/lib/libboost_regex-gcc48-mt-1_55.so.1.55.0 \
    -D Boost_SYSTEM_LIBRARY=$DEPSDIR/lib/libboost_system-gcc48-mt-1_55.so.1.55.0 \
    -D Boost_THREAD_LIBRARY=$DEPSDIR/lib/libboost_thread-gcc48-mt-1_55.so.1.55.0 \
    -D Boost_WAVE_LIBRARY=$DEPSDIR/lib/libboost_wave-gcc48-mt-1_55.so.1.55.0 \
