/****************************************************************************
** Meta object code from reading C++ file 'entityeditor.cpp'
**
...
#error "The header file 'entityeditor.cpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_appleseed__studio__ForwardAcceptedSignal[] = {
    ...
    "\0widget_name,page_name,entity_name\0"
    "signal_accepted(QString,QString,QString)\0"
...
void appleseed::studio::ForwardAcceptedSignal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->signal_accepted((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const QString(*)>(_a[3]))); break;
        case 1: _t->slot_accept((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void appleseed::studio::ForwardAcceptedSignal::signal_accepted(const QString & _t1, const QString & _t2, const QString & _t3)
{
